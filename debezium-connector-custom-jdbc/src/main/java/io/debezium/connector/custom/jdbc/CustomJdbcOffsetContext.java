...
public class CustomJdbcOffsetContext extends CommonOffsetContext<SourceInfo> {
    ...
    public CustomJdbcOffsetContext(CustomJdbcConnectorConfig connectorConfig, TxLogPosition position, boolean snapshot, boolean snapshotCompleted, long eventSerialNo,
    ...
    public CustomJdbcOffsetContext(CustomJdbcConnectorConfig connectorConfig, TxLogPosition position, boolean snapshot, boolean snapshotCompleted) {
    ...
    public static class Loader implements OffsetContext.Loader<CustomJdbcOffsetContext> {

        private final CustomJdbcConnectorConfig connectorConfig;

        public Loader(CustomJdbcConnectorConfig connectorConfig) {
            this.connectorConfig = connectorConfig;
        }

        @Override
        public CustomJdbcOffsetContext load(Map<String, ?> offset) {
            ...
            return new CustomJdbcOffsetContext(connectorConfig, TxLogPosition.valueOf(commitLsn, changeLsn), snapshot, snapshotCompleted, eventSerialNo,
    ...
    public String toString() {
        return "CustomJdbcOffsetContext [" +
